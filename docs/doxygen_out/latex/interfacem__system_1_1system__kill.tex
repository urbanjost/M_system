...
\hypertarget{interfacem__system_1_1system__kill_autotoc_md17}{}\doxysubsubsection{N\+A\+ME}\label{interfacem__system_1_1system__kill_autotoc_md17}
system\+\_\+kill(3f) -\/ \mbox{[}M\+\_\+system\+:S\+I\+G\+N\+A\+LS\mbox{]} send a signal to a process or a group of processes (L\+I\+C\+E\+N\+SE\+:PD)\hypertarget{interfacem__system_1_1system__kill_autotoc_md18}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{interfacem__system_1_1system__kill_autotoc_md18}
\begin{DoxyVerb}integer(kind=c_int) function system_kill(pid,sig)

   integer,intent(in) :: pid
   integer,intent(in) :: sig
\end{DoxyVerb}
\hypertarget{interfacem__system_1_1system__kill_autotoc_md19}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{interfacem__system_1_1system__kill_autotoc_md19}
...
shall be sent.
\end{DoxyVerb}
\hypertarget{interfacem__system_1_1system__kill_autotoc_md20}{}\doxysubsubsection{R\+E\+T\+U\+R\+N V\+A\+L\+UE}\label{interfacem__system_1_1system__kill_autotoc_md20}
\begin{DoxyVerb}Upon successful completion, 0 shall be returned. Otherwise, -1 shall be
returned and errno set to indicate the error.
\end{DoxyVerb}
\hypertarget{interfacem__system_1_1system__kill_autotoc_md21}{}\doxysubsubsection{E\+R\+R\+O\+RS}\label{interfacem__system_1_1system__kill_autotoc_md21}
The kill() function shall fail if\+:

E\+I\+N\+V\+AL The value of the sig argument is an invalid or unsupported signal number. E\+P\+E\+RM The process does not have permission to send the signal to any receiving process. E\+S\+R\+CH No process or process group can be found corresponding to that specified by pid. The following sections are informative.\hypertarget{interfacem__system_1_1system__kill_autotoc_md22}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{interfacem__system_1_1system__kill_autotoc_md22}
Sample program\+:

...
\hypertarget{interfacem__system_1_1system__umask_autotoc_md72}{}\doxysubsubsection{N\+A\+ME}\label{interfacem__system_1_1system__umask_autotoc_md72}
system\+\_\+umask(3fp) -\/ \mbox{[}M\+\_\+system\mbox{]} set and get the file mode creation mask (L\+I\+C\+E\+N\+SE\+:PD) \hypertarget{interfacem__system_1_1system__umask_autotoc_md73}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{interfacem__system_1_1system__umask_autotoc_md73}
\begin{DoxyVerb}integer(kind=c_int) function system_umask(umask_value)
\end{DoxyVerb}
\hypertarget{interfacem__system_1_1system__umask_autotoc_md74}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{interfacem__system_1_1system__umask_autotoc_md74}
...
Bit positions that are set in cmask are cleared in the mode of the created file.\hypertarget{interfacem__system_1_1system__umask_autotoc_md75}{}\doxysubsubsection{R\+E\+T\+U\+R\+N V\+A\+L\+UE}\label{interfacem__system_1_1system__umask_autotoc_md75}
The file permission bits in the value returned by umask() shall be the previous value of the file mode creation mask. The state of any other bits in that value is unspecified, except that a subsequent call to umask() with the returned value as cmask shall leave the state of the mask the same as its state before the first call, including any unspecified use of those bits.\hypertarget{interfacem__system_1_1system__umask_autotoc_md76}{}\doxysubsubsection{E\+X\+A\+M\+P\+LE}\label{interfacem__system_1_1system__umask_autotoc_md76}
Sample program\+:
